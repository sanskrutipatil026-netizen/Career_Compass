...
Rules:
- Return exactly 3 to 5 stages.
- Put the stages in logical progression order.
- Each stage must have a short stage name.
- Each stage must contain 2 to 5 short keywords.
- Do NOT write paragraphs.
- Do NOT write explanations.
- Do NOT write long sentences.
- Do NOT create a theoretical roadmap.
- The roadmap must be suitable for displaying as connected blocks with arrows.
